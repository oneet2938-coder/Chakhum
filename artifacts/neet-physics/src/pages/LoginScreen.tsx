...
type Step = "role" | "student-form" | "teacher-code";
...
export default function LoginScreen() {
  ...
  async function handleStudentLogin(e: React.FormEvent) {
    ...
    try {
      ...
      login({ role: "student", name: student.name, phone: student.phone, studentId: student.id });
    } catch {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6">
      ...
      {/* Card */}
      <div className="w-full max-w-sm bg-card border border-card-border rounded-xl shadow-xl overflow-hidden">
        {step === "role" && (
          <div className="p-6">
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <p className="text-xs text-muted-foreground">Practice MCQs and take mock tests</p>
                </div>
              </button>
        ...
        {step === "student-form" && (
          <div className="p-6">
            ...
            <form onSubmit={handleStudentLogin} className="space-y-4">
              ...
              >
                {loading ? "Logging in…" : "Enter Student Panel"}
              </button>
            </form>
          </div>
        )}
      ...
      <p className="text-[11px] text-muted-foreground mt-6">EMC Physics · NEET 2025</p>
    </div>
  );
}
